  ...
  <section>
    ...
    <div id="tap_area1">
      ...
      <span id="tap2">
        ...
        <h3>제임스의 실내 케어 </h3>
        <a href="#" v-on:click="test2">우리집을 부탁해 !</a>
      </span>
    </div>
...
export default {
  ...
  methods: {
    init_user() {
      let userData = {};
      userData.id = this.$cookies.get('user_id');

      try {
        http.post("/home", JSON.stringify(userData),
          {
            headers: {
          ...
          .then((res) => {
            ...
            // }
            // else {
            //   this.$store.commit('initUserName', res.data);
